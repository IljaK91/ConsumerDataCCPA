...
plot_comp_static_firm(x, [prof_LU, prof_BU, prof_LS, prof_BS]; xlabel = xlabel, ylabel = "Profits", Filename = "Profits_nu_GE")
...
plot_comp_static_firm(x, [D_LU, D_BU, D_LS, D_BS]; xlabel = xlabel, ylabel = "Data Bundle", Filename = "DataBundle_nu_GE")
...
plot_comp_static_firm(x, [D_I_LU, D_I_BU, D_I_LS, D_I_BS]; xlabel = xlabel, ylabel = "Internal Data", Filename = "Internal_Data_nu_GE")
...
plot_comp_static_firm(x, [D_E_LU, D_E_BU, D_E_LS, D_E_BS]; xlabel = xlabel, ylabel = "External Data", Filename = "External_Data_nu_GE")
...
plot_comp_static_firm(x, [D_S_LU, D_S_BU, D_S_LS, D_S_BS]; xlabel = xlabel, ylabel = "Shared Data", Filename = "Shared_Data_nu_GE")
...
savefig("Graphs/Aggregate_GE_nu.pdf")
savefig("Graphs/Aggregate_GE_nu.png")
...
savefig("Graphs/FirmGraphProfits_GE_nu.png")
savefig("Graphs/FirmGraphProfits_GE_nu.pdf")
...
savefig("Graphs/FirmGraphDataNorm_GE_nu.png")
savefig("Graphs/FirmGraphDataNorm_GE_nu.pdf")
...
savefig("Graphs/FirmGraphData_GE_nu.png")
savefig("Graphs/FirmGraphData_GE_nu.pdf")